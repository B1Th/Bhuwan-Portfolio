...
const Window = () => {
  ...
  const scale = useTransform(scrollYProgress1, [0, 1], [1, 10]);
  const xStar = useTransform(scrollYProgress1, [0, 1], ["0%", "50%"]);
  const yText = useTransform(scrollYProgress1, [0, 1], ["-40%", "60%"]);
  const yPlanet = useTransform(scrollYProgress1, [0, 1], ["-40%", "60%"]);
  const yMount = useTransform(scrollYProgress2, [0, 1], ["10%", "0%"]);
